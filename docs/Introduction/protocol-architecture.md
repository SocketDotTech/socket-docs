...
Plugs are required to follow a contract specification to interface with Socket contracts. Learn more about the [specs here](../Getting-Started/introducing-plugs.md).
