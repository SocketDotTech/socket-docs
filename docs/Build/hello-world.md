...
That's it! You can now track the status of your message using the [Status Tracking API](../Dev%20Resources/APIReference/Track.md). Once your transaction is successful, you'll be able to see the `message` value set to "Hello World" on Goerli.
